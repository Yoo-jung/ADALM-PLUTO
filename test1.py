...
class test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 10000, 10000, 200)
        ...
        self.iio_pluto_sink_0 = iio.pluto_sink('192.168.2.1', 2400000000, samp_rate, 20000000, 32768, True, 10.0, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_sink_0.set_params(2400000000, self.samp_rate, 20000000, 10.0, '', True)
