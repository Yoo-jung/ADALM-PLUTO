...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 10000, 0, 200)
        ...
        self.iio_pluto_source_0 = iio.pluto_source('ip:192.168.3.1', 2400000000, samp_rate, 20000000, 32768, True, True, True, 'manual', rx_gain, '', True)
        self.iio_pluto_sink_0_0 = iio.pluto_sink('ip:192.168.3.1', 144150000, samp_rate, 200000, 16384*2, False, rx_gain, '', True)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.iio_pluto_sink_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_sink_0_0.set_params(144150000, self.samp_rate, 200000, self.rx_gain, '', True)
        self.iio_pluto_source_0.set_params(2400000000, self.samp_rate, 20000000, True, True, True, 'manual', self.rx_gain, '', True)
